...
HD_PWD='C:/Diak/LorinczNorbert/UKDA/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log audio_output.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source audio_output.tcl
