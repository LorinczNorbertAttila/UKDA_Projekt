...
HD_PWD='C:/Uni/Ujrakonfiguralhato digitalis aramkorok/7.felev/UKDA_Projekt/project/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_modul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_modul.tcl
