...
HD_PWD='C:/Uni/Ujrakonfiguralhato digitalis aramkorok/7.felev/UKDA_Projekt/project/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_modul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_modul.tcl -notrace
